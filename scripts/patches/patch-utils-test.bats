...
setup() {
  load "./patch-utils.sh"
  cp -r "$TESTS_DIRECTORY/resources/patch-utils" "/tmp"
}
...
@test "apply_patches | file with list of files to patch not found" {
  run apply_patches "/non-existing-file"
  assert_status 1
...
@test "apply_patches | ignore invalid lines in file with list of files to patch | empty lines" {
  ...
  local original_directory="$TESTS_DIRECTORY/resources/patch-utils/apply-patches"
  ...
  assert_equal "$(count_files "$directory/backups")" 2
  assert_exist "$directory/backups/file-0"
  assert_exist "$directory/backups/file-1"
  assert_files_equal "$directory/backups/file-0" "$original_directory/files/before-patch/file-0"
  assert_files_equal "$directory/backups/file-1" "$original_directory/files/before-patch/file-1"
...
@test "revert_patches | file with list of files to revert not found" {
  run revert_patches "/non-existing-file"
  assert_status 1
...
@test "revert_patches | ignore invalid lines in file with list of files to revert | empty lines" {
  ...
  local original_directory="$TESTS_DIRECTORY/resources/patch-utils/revert-patches"
  ...
  assert_files_equal "$directory/files/after-patch/file-0" "$original_directory/backups/file-0"
  assert_files_equal "$directory/files/after-patch/file-1" "$original_directory/backups/file-1"
}
